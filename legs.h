...
String sapu_ssc(int x) {
  // 5 kaki lain diam di posisi READY
  ...
  // 6 titik dasar dari ujung kanan (11,-1) ke ujung kiri (0,5), SEMUA z=0
  float bp[6][2] = {
    { 11.0, -1.0 },
    {  8.8,  0.2 },
    {  6.6,  1.4 },
  ...
  // urutan frame: maju 0->5, lalu balik 5->0 (kayak wiper), total 10 frame
  int seq[10] = { 0, 1, 2, 3, 4, 5, 4, 3, 2, 1 };
  int b = seq[x];

  float L1pos[3] = { bp[b][0] + C0L[0][0], bp[b][1] + C0L[0][1], 0 + C0L[0][2] };

  //================================================== L1 (swipe) ==================================================
  int gamaL1  = round(L01[0] + myFunctionPWM(getgamaL(L1pos[0], L1pos[1], L1pos[2])));
  int alphaL1 = round(L01[1] + myFunctionPWM(getalphaL(L1pos[0], L1pos[1], L1pos[2])));
  int betaL1  = round(L01[2] + myFunctionPWM(getbetaL(L1pos[0], L1pos[1], L1pos[2])));
  //================================================== L2 (ready) ==================================================
...
void sapu_step() {
  switch (state_nextStep) {
    ...
    case 3: Serial2.print(String(sapu_ssc(3))); state_nextStep = 4; break;
    case 4: Serial2.print(String(sapu_ssc(4))); state_nextStep = 5; break;
    case 5: Serial2.print(String(sapu_ssc(5))); state_nextStep = 6; break;
    case 6: Serial2.print(String(sapu_ssc(6))); state_nextStep = 7; break;
    case 7: Serial2.print(String(sapu_ssc(7))); state_nextStep = 8; break;
    case 8: Serial2.print(String(sapu_ssc(8))); state_nextStep = 9; break;
    case 9: Serial2.print(String(sapu_ssc(9))); state_nextStep = 0; break;
  }
}
