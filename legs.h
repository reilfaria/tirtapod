    ...
    if (isRight == LOW) {
      if (homestate == false && overallhome == false) {
        ...
        if (overallR4 == true && overallR5 == false) {
          ...
          if (positioningR5 == true && kompas5 == true) {
            ...
            int comVal = radius(cposPuingR, F, 5);
            if (comVal == 1) {
      ...
      if (comVal == 0) {
        ...
        if (overallhome == true && overallR1 == false) {
          if (human[1] == false && camerastate[1] == false) {
            TOFKanan = TOF::getkanan();
            if (TOFKanan > 550 && kompasR1 == false) {
              int comVal = radius(cposhumanL[1]);
              if (comVal == 0) {
                kompasR1 = true;
              } else if (comVal == 1) {
                legs::rotate_left_low();
            ...
            } else if (TOFKanan > 550 && kompasR1 == true) {
              while (millis() - gettimeR1N <= 2000) {
                legs::walkspeed = 100;
                legs::backward_low();
                oled.clearBuffer();
        ...
        if (overallR2 == true && overallR3 == false) {
          ...
          if (capitnaik == true && human1aman == false && positioningR3 == false && kompas3 == true && tembok3 == false) {
            ...
            // 1. Jalankan shift kiri selama 2 detik (HANYA SEKALI)
            if (shiftR3Done == false) {
              legs::walkspeed = 180;
              unsigned long t = millis();
              while (millis() - t <= 2000) {
            ...
            // 4. Koreksi Kiri (Jalan jika front3 sudah true)
            if (front3 == true) {
              if (TOFKiri < 130) {
                legs::shift6_right();
              } else if (TOFKiri > 150) {
        ...
        if (overallR4 == true && overallR5 == false) {
          ...
          if (positioningR5 == true && kompas5 == true) {
            ...
            int comVal = radius(cposPuingL, F, 5);
            if (comVal == 1) {
              legs::rotate_left_slow();
            } else if (comVal == -1) {
              legs::rotate_right_slow();
        ...
        if (overallR5 == true && overallR6 == false) {
          ...
          if (wallfollowingR6 == false && positioningR6 == false && tembok6kanan == false) {
            ...
            // tahap 1: shift kanan sampai TOFKanan >= 235
            if (doneHuman6 == false && rotateH6 == false && camerastate[3] == false && human[3] == false && mundur6humanR6 == false && kompasBalik6 == false) {
              if (TOFKiri > 380) {
                rotateH6 = true;
              } else {
            ...
            if (ambilhuman4 == true && gantikorban4 == true && camerastate[4] == false && human[4] == false) {
              Serial.println("prepare camera 6 (human 4)");
              int comVal = radius(cposhumanL[3], R, 10);
              if (comVal == 1) {
                legs::rotate6_left();
              } else if (comVal == -1) {
                legs::rotate6_right();
            ...
            // tahap 5: rotate balik ke cposL[6], setelah pas lanjut normal lagi
            if (doneHuman6 == false && rotateH6 == true && selesaiHuman6 == true && mundur6humanR6 == true && kompasBalik6 == false) {
              int comVal = radius(cposL[6], F, 8);
              if (comVal == 0) {
                kompasBalik6 = true;
                doneHuman6 = true;
              } else if (comVal == 1) {
          ...
          // akhir Ruangan 6 Kiri
          if (wallfollowingR6 == true && positioningR6 == true && tembok6kanan == true && overallR6 == false) {
            Serial.println("ruangan 7");
            legs::walkspeed = 150;

            if (kompas7set == false) {
              int comVal = radius(cposL[7], F, 2);
              if (comVal == 0) {
                kompas7set = true;
              } else if (comVal == 1) {
                legs::rotate6_left();
        ...
        if (overallR6 == true && overallR7 == false) {
          ...
          if (kiri == false && stuck == false && tembok7 == false) {
            ...
            if (faseKeluar) {
              ...
              oled.sendBuffer();
              legs::walkspeed = 300;
              int comVal = radius(cpostanggaL, L, 20);
              if (comVal == 1) {
                legs::rotate6_left_1cm();
              } else if (comVal == -1) {
                legs::rotate6_right_1cm();
          ...
          if (kiri == true && stuck == false && tembok7 == false) {
            ...
            if (kiri == true) {
              ...
              // ==========================================
              if (kompas8 == false) {
                int comVal = radius(cpossafeL[4], L, 5);
                if (comVal == 0) {
                  kompas8 = true; // Rotasi selesai, kunci kompas8
                } else if (comVal == 1) {
                  legs::rotate6_left();
        ...
        // 1. Cek Kompas & Deteksi Human 5
          if (kompas8 == false && human[5] == false) {
            ...
            int comVal = radius(cposhumanL[5]);
            ...
            if (comVal == 0) {
              ...
              legs::rotate6_left(); // Target di kanan -> Putar Kanan
            } 
            else {
              legs::rotate6_right();  // FIX: Target di kiri -> Putar Kiri
            }
          }
